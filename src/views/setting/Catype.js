...
import {getCatypes, getCatype, registerCatype, updateCatype, deleteCatype} from './../../actions/setting/catype';
...
//GET CATYPES PER SCHOOL
  useEffect(() => {
    let params = {
      ...
      cat:'select',
      table:'catypes',
      narration:'get catypes'
  }
    props.getCatypes(params)
  ...
  const handleSubmit = () =>{
    if(namez.length > 0){
      ...
      }else
      {
        ...
        props.registerCatype(fd)
      }
      onReset()
    }
  }
 
  let data = props.catypes.catypes && Array.isArray(props.catypes.catypes) ? props.catypes.catypes.filter(rw =>rw !== null || rw !== undefined) : []
    ...
    <CRow>
      <CCol >
        <CCard>
          ...
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Catypes</h4>
          ...
          <table className="table table-hover table-outline mb-0  d-sm-table">
                <thead className="thead-light">
                  <tr>
                    ...
                    <th><i className='fa fa-list'></i> Catype</th>
        ...
        <CCard>
            <CCardHeader id='traffic' className="card-title mb-0">
              <CRow>
                <CCol sm="6">
                <h4>{ id && parseInt(id) > 0 ? 'Edit' : 'Add'} <small> Catype</small></h4>
                </CCol>
            ...
            <CCardBody>
              <CForm action="" method="post">
                <CFormGroup>
                  <CLabel htmlFor="nf-name">Catype</CLabel>
                  <CInput 
                      type="text" 
                      id="nf-name" 
                      name="namez"
                      ...
                      placeholder="Science" 
                    />
                  <CFormText className="help-block">Please enter catype name</CFormText>
                </CFormGroup>
                <CFormGroup>
                  <CLabel htmlFor="nf-abbrv">Catype Abbrv </CLabel>
                  <CInput 
                      type="text" 
                      id="nf-abbrv" 
                      name="abbrv"
                      ...
                      placeholder="SCI" 
                    />
                  <CFormText className="help-block">Please enter catype abbrv (max 6 characters)</CFormText>
                </CFormGroup>
