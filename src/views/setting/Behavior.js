    ...
    <CRow>
      <CCol >
        <CCard>
          ...
          <CRow>
            <CCol sm="5">
            <h4 id="traffic" className="card-title mb-0">{termname} : <small>Behavioral Assessment</small></h4>
          ...
          <table className="table table-hover table-outline mb-0  d-sm-table">
                <thead className="thead-light">
                  <tr>
                    ...
                    <th><i className='fa fa-list text-center'></i> BEHAVIOR NAME</th>
              ...
              <CForm action="" method="post">
                <CFormGroup>
                  ...
                  <CInput 
                    ...
                    />
                  <CFormText className="help-block">set behaviors name</CFormText>
                </CFormGroup>
                <CFormGroup>
